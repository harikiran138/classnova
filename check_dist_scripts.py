...
commands = [
    "ls -F /home/classnova/NovaBoard_Deployed/excalidraw-app/dist-app || echo 'no dist-app'",
    "cat /home/classnova/NovaBoard_Deployed/excalidraw-app/package.json | grep -A 15 '\"scripts\":'"
]
