...
commands = [
    "find /home/classnova/NovaBoard_Deployed -name index.html | grep dist",
    "find /home/classnova/NovaBoard_Deployed -name index.html | grep build",
    "ls -R /home/classnova/NovaBoard_Deployed/excalidraw-app | grep ': ' | head -n 20"
]
