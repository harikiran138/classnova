...
run_ssh_command(target_ip, user, password, "cat /home/classnova/NovaBoard_Deployed/excalidraw-app/.env.production")

# 2. Read vite config
run_ssh_command(target_ip, user, password, "cat /home/classnova/NovaBoard_Deployed/excalidraw-app/vite.config.mts")
