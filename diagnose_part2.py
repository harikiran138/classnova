...
commands = [
    "cat /home/classnova/NovaBoard_Deployed/excalidraw-app/package.json",
    "pm2 status",
    "ls -F /home/classnova/NovaBoard_Deployed/excalidraw-app/dist || echo 'no dist folder'",
    "ls -F /home/classnova/NovaBoard_Deployed/excalidraw-app/build || echo 'no build folder'"
]
