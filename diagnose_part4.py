...
# grep context to see scripts block. package.json usually has "scripts" near the top.
# -A 20 should capture most scripts.
commands = [
    "grep -A 20 '\"scripts\":' /home/classnova/NovaBoard_Deployed/excalidraw-app/package.json"
]
